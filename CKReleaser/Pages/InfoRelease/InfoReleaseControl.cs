#region LGPL License
/*----------------------------------------------------------------------------
* This file (CKReleaser\Pages\InfoRelease\InfoReleaseControl.cs) is part of CiviKey. 
*  
...
{
    partial class InfoReleaseControl : PageControl
    {
        public readonly InfoReleasePage Page;
        public readonly TreeNode Node;
        public readonly InfoRelease InfoRelease;

        public InfoReleaseControl( InfoReleasePage page, TreeNode node, InfoRelease r )
        {
            Page = page;
            Node = node;
            InfoRelease = r;
            InitializeComponent();
            _baseReleaseDataEditor.Initialize( page, r );
            _launchReleasePanel.Initialize( Page, r );
            RefreshDBView();
        }

        public override void RefreshDBView()
        {
            _folderPath.Text = InfoRelease.Path;
